...
const Landing = () => {
    ...
    return (
        <div id="landing" className="h-[80vh] flex flex-col justify-center items-center snap-center pt-14">
            <animated.h1 style={fade} className="text-4xl font-bold mb-6 text-center">Hello, I'm Benjamin Podmore</animated.h1>
